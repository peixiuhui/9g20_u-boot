...
#define CONFIG_SPLASH_MCTECH		1
/* choose one */
//#define CONFIG_LCD240X320             1
//#define CONFIG_LCD480X272             1
#define CONFIG_LCD640X480               1
//#define CONFIG_LCD800X480             1
//#define CONFIG_LCD800X600             1
#ifdef CONFIG_SPLASH_MCTECH
#define CONFIG_SPLASH_SCREEN		1
#define SPLASH_SCREEN_OFFSET 0x50000
#define SPLASH_SCREEN_ADDR (CFG_DATAFLASH_LOGIC_ADDR_CS0 + SPLASH_SCREEN_OFFSET)
#define SPLASH_SCREEN_LOAD_ADDR     0x23D00000
#else
...
/*#define CONFIG_BOOTCOMMAND      "run ker;run fs; bootm 22200000"
#define CONFIG_BOOTARGS         "console=ttyS0,115200 "                 \
                                "root=/dev/ram0 "                       \
                                "initrd=0x21100000,6M "         \
*/
