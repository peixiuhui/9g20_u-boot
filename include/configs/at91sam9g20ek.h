...
#define AT91_MAIN_CLOCK               396000000       /* from 12 MHz crystal */
#define AT91_MASTER_CLOCK     132000000       /* peripheral = main / 3 */
#define CFG_HZ                        1000000         /* 1us resolution */
...
#define CFG_ENV_SIZE		0x4200
#define CONFIG_BOOTCOMMAND	"nand read.e 22200000 0 200000; bootm 22200000"
#define CONFIG_BOOTARGS		"console=ttyAT0,115200 "			\
				"root=/dev/mtdblock1 "			\
				"rw rootfstype=jffs2"
...
#define CONFIG_BOOTCOMMAND	"nand read.e 22200000 100000 200000; bootm 22200000"
#define CONFIG_BOOTARGS		"console=ttyAT0,115200 "			\
				"root=/dev/mtdblock1 "			\
				"mtdparts=at91_nand:3M(linux)ro,"	\
				"-(root) "	\
				"rw rootfstype=jffs2"
