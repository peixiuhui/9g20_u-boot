...
int lcd_display_bitmap(ulong bmp_image, int x, int y)
{
	...
	read_dataflash(SPLASH_SCREEN_ADDR, sizeof(bmp_image_t), (char *)bmp);
#endif 
...
#ifdef CONFIG_SPLASH_MCTECH
	read_dataflash(SPLASH_SCREEN_ADDR, bmp->header.file_size, (char *)bmp);
#endif
...
# error "Don't know location of color map"
	...
	memset(lcd_base, *bmap, panel_info.vl_row*panel_info.vl_col);
...
static void *lcd_logo (void)
{
	...
	if (do_splash ) {
		do_splash = 0;
			lcd_display_bitmap (SPLASH_SCREEN_LOAD_ADDR, 0, 0) ;
