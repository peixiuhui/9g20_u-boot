...
void lcd_enable(void)
{
	...
	at91_set_gpio_value(AT91_PIN_PB4, 1);  /* lcc on */
}

void lcd_disable(void)
{
	at91_set_gpio_output(AT91_PIN_PB4, 0);
	at91_set_gpio_value(AT91_PIN_PB4, 0);  /* lcc off */
}
static void at91sam9261ek_lcd_hw_init(void)
{
	at91_set_A_periph(AT91_PIN_PB0, 0);	/* LCDHSYNC */
...
//	at91_set_A_periph(AT91_PIN_PB15, 0);	/* LCDD10 */
...
#if defined(CONFIG_LCD800X480) || defined(CONFIG_LCD640X480)
	...
	gd->fb_base = 0x23e00000;//AT91SAM9261_SRAM_BASE;
}
#endif
